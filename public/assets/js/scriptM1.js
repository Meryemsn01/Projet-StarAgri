...
const fetchData = (city) => {
    ...
    const apiKey = 'cdff9fc6736fd16b9b95977f09d0b52c';
...
const city = 'Paris'; // Replace with the desired city
...
fetch(`https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=${apiKey}&units=metric`)
    ...
    .then(data => {
        ...
        document.querySelector('.weather-icon').style.backgroundImage = `url('http://openweathermap.org/img/w/${weatherIcon}.png')`;
